<div class="container py-8">
    <x-table-responsive>
        <div class="flex px-6 py-4">
            <input wire:keydown="limpiar_page" wire:model="search" class="flex-1 shadow-sm form-input"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-10 h-10">
                                        ...
                                        @else
                                            <img class="object-cover object-center w-10 h-10 rounded-full"
                                                src="https://images.pexels.com/photos/4462782/pexels-photo-4462782.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"
                                                alt="">
                                        @endisset
                                    </div>
                                    <div class="ml-4">
