<x-app-layout>
    <section class="bg-cover" style="background-image: url({{ asset('img/home/people-2557399_1920.jpg') }})">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 py-36">
            <div class="w-full md:w-3/4 lg:w-1/2">
                ...
                <p class="mt-2 mb-4 text-lg text-white">En Coders Free encontrarás cursos, manuales y artículos que te
                    ayudarán a
                    convertirte en un profesional
                    del desarrollador web
                </p>
    ...
    <section class="mt-24">
        ...
        <div class="grid grid-cols-1 px-4 mx-auto gap-x-6 gap-y-8 max-w-7xl sm:px-6 lg:px-8 sm:grid-cols-2 ms:grid-cols-3 lg:grid-cols-4">
            <article>
                ...
                <p class="text-sm text-gray-500 ">Mussum Ipsum, cacilds vidis litro abertis. Admodum accumsan disputationi eu sit. Vide electram sadipscing et per.
                </p>
            </article>
            <article>
                <figure>
    ...
    <section class="py-12 mt-24 bg-gray-700">
        ...
        <p class="text-center text-white">Dirigete al catalogo de cursos y filtrados por categoria o nivel</p>
    ...
    <section class="my-24">
        ...
        <p class="mb-6 text-sm text-center text-gray-500">Trabajo duro para seguir subiendo cursos</p>
        <div class="grid grid-cols-1 px-4 mx-auto gap-x-6 gap-y-8 max-w-7xl sm:px-6 lg:px-8 sm:grid-cols-2 ms:grid-cols-3 lg:grid-cols-4">
            ...
            <article class="overflow-hidden bg-white rounded shadow-lg">
                ...
                <div class="px-6 py-4">
                    ...
                    <a href="{{ route('course.show', $course) }}" class="block w-full px-4 py-2 mt-2 font-bold text-center text-white bg-blue-500 rounded  hover:bg-blue-700">
                        Más información
                    </a>
                </div>
